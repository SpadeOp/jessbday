...
document.addEventListener('click', () => {
  // Your existing click operations can go here...

  // Set a timer to show the blur background and birthday note after 5 seconds
  setTimeout(() => {
      const blurBackground = document.getElementById('blur-background');
      const birthdayNote = document.getElementById('note');
      
      blurBackground.style.display = 'flex'; // Show the blur background
      birthdayNote.style.display = 'block'; // Show the birthday note
  }, 14000); // 5000 milliseconds = 5 seconds
});
